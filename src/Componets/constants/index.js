export const myProjects = [
  ...
  },
  {
    ...
    subDescription: [
      "Developed a responsive WordPress theme using HTML5, CSS5, and JavaScript.",
    ...
    contents: [
      "As an IT intern in a microfinance setting of CAMCUL helped  the organization’s technology operations",
       'by assisting with hardware and software maintenance, troubleshooting user issues, and ensuring smooth network connectivity.',
        'Managed core microfianance system, update databases, and provide technical support to staff.',
...
export const reviews = [
  ...
  },
  {
    name: "Jill",
    username: "@jill",
    body: "Tracy you are quiet good. Greate work so far ",
