    ...
    <section className='c-space section-spacing'>
      ...
      md:auto-rows-[18rem] mt-12'>
        <div className='flex items-end grid-default-color grid-1'>
          <img src='/public/assets/coding-pov.png'
          className='absolute scale-[1.75] -right-[5rem] -top-[1rem] md:scale-[3]
          md:left-50 md:inset-y-10 lg:scale-[2.5]'/>
          <div className='z-10'>
            <p className='headtexxt'>Hi, I'm Menyam </p>
            <p className='subtext'>  
              Over the years , I developed my software development skills to deliver
              dynamic and responsive software and web applications
            </p>

          </div>
          <div className='absolute inset-x-0 pointe-evets-none-bottom-4
...
<div className='z-10 w-[50%]'>
  ...
  <p className='subtext'>I'm based in Cameroon, and open to remote work
    worldwide
  </p>
...
<div className='grid-default-color grid-5'>
  <div className='z-10 w-[50%]'>
    ...
    <p className='subtext'>I specialize in a variety
      of languages, frameworks, and tools that allow
      me to build scalable applications
    </p>
  </div>
